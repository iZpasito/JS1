...
export default function UpdateInformaciones(){
        return(
            <div>
                <Rhead/>
                <BarraNav/>
                ...
                <div class="post-right-content" >
                    <div className="Container-text"><h3 class="Container-h3">Oferta de Trabajo PFalimentos</h3></div>
                        <div className="cont-btn-del-upinf"><button className="btn-edit-upinf"><Link to='/update/avisos'>Editar</Link></button><button className='btn-del-upinf'>Eliminar</button></div>
